...
import (
	...
	docv1 "github.com/obnahsgnaw/socketgwserviceapi/gen/socketgw_frontend_api/doc/v1"
...
func init() {
	register.Register(func(p *register.Provider) {
		c := p.RegisterFrontendController("doc", docv1.DocService_ServiceDesc, func() interface{} {
